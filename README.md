...
<head>
    ...
    <style>
        * {
        ...
        /* تنسيق الصورة GIF */
        .main-gif {
            max-width: 200px; /* لتظهر بشكل أكبر قليلاً */
            height: auto;
            border-radius: 15px; /* لمسة جمالية */
            margin-bottom: 20px;
...
<body>
    ...
    <div class="container">
        ...
        <div class="hidden-content" id="restOfMessage">
            ...
            <div class="card">
                <h1>كلام القلب ❤️</h1>
                <p>جنت خايف أحجي، قلبي ملى من الحب وما عاد يكدر يسكت أكثر من هيج، لازم تعرفين شعوري.</p>
            </div>
            ...
            <div class="card" id="card5">
                ...
                <div class="buttons-container">
                    <button class="btn-yes" onclick="showLove()"> حموداتي أكيد أقبل أحبك! 😍</button>
    ...
    <script>
        ...
        function continueToLove() {
            ...
            // تشغيل الموسيقى (بسبب تفاعل المستخدم)
            if (music.paused) {
                music.play().catch(error => {
                    console.log("Audio play failed:", error);
                    // هنا يمكن إضافة رسالة للمستخدم لتشغيل الصوت يدوياً إذا فشل التشغيل التلقائي
                });
            }
        ...
        function showLove() {
            ...
            document.getElementById('backgroundMusic').pause(); // إيقاف الموسيقى عند القبول
        }
    </script>
</body>
</html>
